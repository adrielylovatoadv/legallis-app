...
export const ANDAMENTOS_PROCESSO = [
  "AC - AUDIÊNCIA DE CONCILIAÇÃO","ACORDO","AGUARDAR LIMINAR","AGUARDAR PRAZO RÉU","AGUARDAR SENTENÇA",
  ...
  "RECURSO","RECURSO 2º GRAU","REDISTRIBUIÇÃO","RÉPLICA","RÉPLICA SEM INTIMAÇÃO","SUSPENSO",
];
